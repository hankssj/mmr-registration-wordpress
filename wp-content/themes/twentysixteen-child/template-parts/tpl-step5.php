...
if(!empty($vocal)){
  ...
  <tr>
    <td>
      ...
      <textarea  name="groups_during_year<?php echo $v; ?>"><?php echo $voice_array->groups_during_year ;?></textarea>
    </td>
  </tr>
  <tr>
    <td>
      <label>Do any of these groups require an audition? : </label>
      <input type="radio" <?php if($voice_array->required_audition =="yes"){echo "checked"; } ?> name="required_audition<?php echo $v; ?>" value="yes" />Yes
      <input type="radio" <?php if($voice_array->required_audition =="no"){echo "checked"; } ?> name="required_audition<?php echo $v; ?>" value="no" />No
    </td>
  </tr>
  <tr>
    <td>
  ...
  <tr>
    <td>
      ...
      <input  type="text" name="difficult_peice<?php echo $v; ?>" value="<?php echo $voice_array->difficult_peice; ?>" />
    </td>
  </tr>
  <tr>
    <td>
      ...
      <table>
      <tr><td>Have you studied music theory? <input id="studied_theory_yes<?php echo $v; ?>" type="radio" <?php if($voice_array->studied_theory == "yes"){ echo "checked"; } ?> name="studied_theory<?php echo $v; ?>" value="yes" />Yes
      <input type="radio" id="studied_theory_no<?php echo $v; ?>" <?php if($voice_array->studied_theory == "no"){ echo "checked"; } ?> name="studied_theory<?php echo $v; ?>" value="no" /> No
      </td>

      <td><p id = "studied_theory_year_p<?php echo $v; ?>">What year :</p>  <input id="studied_theory_year<?php echo $v; ?>" type="text"  name="what_year_1<?php echo $v; ?>" value="<?php echo $voice_array->what_year_1; ?>" /></td></tr>
      <tr><td>Have you taken a voice class? 
      <input type="radio" id="voice_class_yes<?php echo $v; ?>" name="voice_class<?php echo $v; ?>" <?php if($voice_array->voice_class == "yes"){ echo "checked"; } ?>  value="yes" /> Yes
      <input type="radio" id="voice_class_no<?php echo $v; ?>" name="voice_class<?php echo $v; ?>" <?php if($voice_array->voice_class == "no"){ echo "checked"; } ?>  value="no" /> No

      </td>

      <td><p id ="voice_class_p<?php echo $v; ?>">What year : </p> <input  type="text" id="what_year_2<?php echo $v; ?>" name="what_year_2<?php echo $v; ?>" value="<?php echo $voice_array->what_year_2;?>" /></td></tr>


      <tr><td>Have you taken a voice lessons? <input id="voice_lessons_yes<?php echo $v; ?>" type="radio" name="voice_lessons<?php echo $v; ?>" <?php if($voice_array->voice_lessons == "yes"){ echo "checked"; } ?> value="yes" /> Yes
      <input type="radio" id="voice_lessons_no<?php echo $v; ?>" name="voice_lessons<?php echo $v; ?>" <?php if($voice_array->voice_lessons == "no"){ echo "checked"; } ?> value="no" /> No
      </td>

      <td><p id="voice_lessons_p<?php echo $v;?>"> What year :</p> <input id="what_year_3<?php echo $v; ?>"  type="text" name="what_year_3<?php echo $v; ?>" value="<?php echo $voice_array->what_year_3?>" /></td></tr>
      </table>
    </td>
  </tr>
  <tr>
...
if(!empty($string)){
 ...
 <table class="custom-table">
  ...
  <tr>
    <td>
      <label>Groups you play/sing with during the year : </label>
      <textarea  name="groups_during_year_string<?php echo $s; ?>"><?php echo $string_array->groups_during_year_string; ?></textarea>
    </td>
  </tr>
  <tr>
    <td>
      <label>Do any of these groups require an audition? : </label>
      <input type="radio" <?php if($string_array->required_audition_string == "yes"){ echo "checked"; }  ?> name="required_audition_string<?php echo $s; ?>" value="yes" /> Yes
      <input type="radio" <?php if($string_array->required_audition_string == "no"){ echo "checked"; }  ?> name="required_audition_string<?php echo $s; ?>" value="no" /> No
    </td>
  </tr>
  <tr>
    <td>
  ...
  <tr>
    <td>
      ...
      <label class="radio-inline">
        ...
        <p id="how_many_years1">For how many years?</p> <input id="how_many_years" value="<?php echo $string_array->how_many_years; ?>" type="text" name="how_many_years<?php echo $s; ?>"  />
      </label>
    </td>
  </tr>
  <tr>
 ...
 <table class="custom-table">
  ...
  <tr>
    ...
    <label class="radio-inline">
      ...
      <p id="how_many_years_piano1">For how many years?</p> <input id="how_many_years_piano" value="<?php echo $piano_array->how_many_years_piano; ?>" type="text" name="how_many_years_piano<?php echo $p; ?>" />
    </td>
  </tr>
  <tr>
    <td>
  ...
  <tr>
    <td>
      ...
      <textarea  name="list_composers_piano<?php echo $p; ?>"><?php echo $piano_array->list_composers_piano; ?></textarea>
    </td>
  </tr>
  <tr>
    <td>
...
<?php 
 ...
 <table class="custom-table">
  ...
  ?>
    ...
    <td>
      <label>Groups you play/sing with during the year : </label>
      <textarea  name="groups_during_year_brass<?php echo $b; ?>"><?php echo $brass_array->groups_during_year_brass; ?></textarea>
    </td>
  </tr>
  <tr>
    <td>
      <label>Do any of these groups require an audition? : </label>
      <input type="radio" <?php if($brass_array->required_audition_brass == "yes"){ echo "checked"; } ?> name="required_audition_brass<?php echo $b; ?>" value="yes" /> Yes
      <input type="radio" <?php if($brass_array->required_audition_brass == "no"){ echo "checked"; } ?> name="required_audition_brass<?php echo $b; ?>" value="no" /> No
    </td>
  </tr>
  ...
  <tr>
    <td>
      ...
      <p id="how_many_years_brass1">For how many years?</p> <input id="how_many_years_brass" value="<?php echo $brass_array->how_many_years_brass; ?>" type="text" name="how_many_years_brass<?php echo $b; ?>" />
    </td>
  </tr>
  <tr>
    <td>
  ...
  <tr>
    <td>
      ...
      <textarea  name="any_other_ins_brass<?php echo $b; ?>"><?php echo $brass_array->any_other_ins_brass; ?></textarea>
    </td>
  </tr>
  <tr>
    <td>
...
<?php $v1 = 0; foreach($vocal as $vocalitems){ ?>
  jQuery('#studied_theory_yes<?php echo $v1; ?>').click(function() {
       if(jQuery('#studied_theory_yes<?php echo $v1; ?>').is(':checked')) { 
        jQuery('#studied_theory_year<?php echo $v1; ?>').show();
        jQuery('#studied_theory_year_p<?php echo $v1; ?>').show();
       }
    });
    jQuery('#studied_theory_no<?php echo $v1; ?>').click(function() {
       if(jQuery('#studied_theory_no<?php echo $v1; ?>').is(':checked')) {
        jQuery('#studied_theory_year<?php echo $v1; ?>').hide();
        jQuery('#studied_theory_year_p<?php echo $v1; ?>').hide();
      }
    ...
    jQuery('#voice_class_yes<?php echo $v1; ?>').click(function() {
       if(jQuery('#voice_class_yes<?php echo $v1; ?>').is(':checked')) { 
        jQuery('#what_year_2<?php echo $v1; ?>').show();
        jQuery('#voice_class_p<?php echo $v1; ?>').show();
       }
    });
    jQuery('#voice_class_no<?php echo $v1; ?>').click(function() {
       if(jQuery('#voice_class_no<?php echo $v1; ?>').is(':checked')) {
        jQuery('#what_year_2<?php echo $v1; ?>').hide();
        jQuery('#voice_class_p<?php echo $v1; ?>').hide();
      }
    ...
    if(jQuery('#voice_class_yes<?php echo $v1; ?>').is(':checked')) { 
     ...
     if(jQuery('#voice_class_no<?php echo $v1; ?>').is(':checked')) {
      ...
      jQuery('#voice_lessons_yes<?php echo $v1; ?>').click(function() {
       if(jQuery('#voice_lessons_yes<?php echo $v1; ?>').is(':checked')) { 
        jQuery('#what_year_3<?php echo $v1; ?>').show();
        jQuery('#voice_lessons_p<?php echo $v1; ?>').show();
       }
    });
    jQuery('#voice_lessons_no<?php echo $v1; ?>').click(function() {
       if(jQuery('#voice_lessons_no<?php echo $v1; ?>').is(':checked')) {
        jQuery('#what_year_3<?php echo $v1; ?>').hide();
        jQuery('#voice_lessons_p<?php echo $v1; ?>').hide();
      }
