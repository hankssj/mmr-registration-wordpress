...
function qpp_setup ($id) {
    ...
    if (!$qppkey['authorised']) {
        ...
        <p>Upgrading gives you access to the very cool \'In Context Checkout\'. </p>
...
function qpp_send_page($id) {
    ...
    <input type="text" style="width:100%" name="mailchimpuser" value="' . $send['mailchimpuser'] . '" /></p>
    <p>THe mailchimp list ID:
    <input type="text" style="width:100%" name="mailchimpid" value="' . $send['mailchimpid'] . '" /></p>
...
function qpp_scripts_init($hook) {
    ...
    wp_enqueue_style( 'qpp_custom_style',plugins_url('quick-paypal-style.php', __FILE__));
    wp_enqueue_media();
